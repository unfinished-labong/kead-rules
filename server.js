...
const TOOLS = [
  {
    ...
    description:
      '한국장애인고용공단 내부규정과 관련 법령·고시에서 조문을 검색한다. ' +
      '규정 내용, 절차, 기준, 금액 등 공단 업무 관련 질문이면 반드시 먼저 호출할 것. ' +
      '결과에 없는 내용은 답변에 쓰지 말 것.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'get_provision',
    description: '문서명과 조문번호로 특정 조문의 원문을 그대로 가져온다. 예: 인사규정 제5조',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'list_documents',
    description: '어떤 규정이 언제 기준으로 수록되어 있는지 확인한다. 답을 못 찾았을 때 수록 범위를 확인하는 용도로도 쓴다.',
    inputSchema: {
      type: 'object',
